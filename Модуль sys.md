...
> sys — стандартный модуль Python, предоставляющий доступ к системным параметрам и функциям, взаимодействующим с интерпретатором. Содержит переменные и функции для работы со средой выполнения, командной строкой, потоками ввода-вывода и внутренним состоянием интерпретатора.
