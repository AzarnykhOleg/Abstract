...
> `requests` — библиотека Python для выполнения HTTP-запросов, предоставляющая удобный API над низкоуровневым `urllib`. 
> 
> Для установки используется команда `pip install requests`.
