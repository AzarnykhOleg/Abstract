...
> pathlib предоставляет объектно-ориентированный интерфейс для работы с путями и файловой системой. 
> 
> Считается современным и более удобным способом работы с путями по сравнению с os.path.
